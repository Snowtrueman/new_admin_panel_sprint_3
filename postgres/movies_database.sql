...
CREATE UNIQUE INDEX genre_idx ON content.genre(name);
...
CREATE UNIQUE INDEX IF NOT EXISTS person_film_work_idx ON content.person_film_work(person_id, film_work_id, role);